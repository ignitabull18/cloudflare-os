...
// them on gatekeeper routes; apps may also opt into primary navigation. No gatekeeper is hardcoded
// here; the set comes from the backend's discovery of bound gatekeepers. Returns [] until
// authenticated/loaded. `GatekeeperAppInfo` is plain data
