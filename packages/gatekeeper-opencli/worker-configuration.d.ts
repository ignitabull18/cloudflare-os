/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 22562c2328405e29e8cd20f21a694b91)
// Runtime types generated with workerd@1.20260801.1 2026-07-27 allow_irrevocable_stub_storage,nodejs_compat
interface __BaseEnv_Env {
	BACKUP_BUCKET: R2Bucket;
	BACKUP_BUCKET_NAME: "$R2_BACKUP_BUCKET_NAME";
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "OpenCliDriver" | "OpenCliGatekeeper" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKUP_BUCKET_NAME" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
declare module "*.txt" {
	const value: string;
