...
import App, { type ComposioManagementClient } from "./App";
import "./styles.css";
...
interface HostCapability extends RpcTarget {
  readonly ui: RpcStub<ComposioManagementClient>;
  subscribeTheme(receiver: AppIframe): Promise<ThemeMode>;
  openExternalUrl(url: string): Promise<void>;
}

const element = document.getElementById("root");
if (!element) throw new Error("Missing Composio app root.");
...
createRoot(element).render(
  <App api={host.ui} openExternalUrl={url => host.openExternalUrl(url)} />,
);
